...
int ellipseRadius = 400;

Slider LoopTimeSlider;
...
void setup(){
  ...
  cp5.addSlider("looptime")
     .setPosition(10,450)
     .setWidth(200)
     .setRange(50,2000) // values can range from big to small as well
     .setValue(500)
   ...
   */ 
  haplyBoard          = new Board(this, "/dev/cu.usbmodem143401", 0);
...
while(1==1) {
    //------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- COMMENTS ARE PUT IN HERE FOR THE PARTS OF THE LAB
